...
offenses <-image_read("C:/Users/cmont/OneDrive/Documents/MLB Stolen Bases/Images/First_Offense_Tag.png")|>
  image_scale('25%')
if(count > 1) {
  offenses <-image_read("C:/Users/cmont/OneDrive/Documents/MLB Stolen Bases/Images/Repeat_Offender_Tag.png")|>
    image_scale('25%')
}
...
#Generating Image####
destfile <- "C:/Users/cmont/OneDrive/Documents/MLB Stolen Bases/Images/output.png"
temp <- tempfile()
...
#Draw Poster####
photo <- image_read("C:/Users/cmont/OneDrive/Documents/MLB Stolen Bases/Images/output.png") |>
  image_scale("480x349") |>
  image_quantize(colorspace = 'gray')|>
  image_enhance() |>
  image_colorize(40, "#C7791A")
poster <- image_read("C:/Users/cmont/OneDrive/Documents/MLB Stolen Bases/Images/Blank_Wanted_template.jpg")
...
poster
image_write(poster, path = "C:/Users/cmont/OneDrive/Documents/MLB Stolen Bases/Images/final_poster.jpeg", format = "jpeg")
